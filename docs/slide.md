...
<!--
本セッションはSignals Deep Diveということで、15分間Signalについて語らせていただくわけですけれども、まず最初にアンケートをとらせていただきたいなと思っております。
signals知ってるよ人〜。使ってる人〜。
...
単純にSignalsのAPIを呼び出して使うだけであれば、Deep Diveする必要はありません。
Deep Diveの価値は、複雑なことをやろうとしたり、想定外の挙動にであったときに、なぜそうなるかを理解できる点にあります。
...
つまり、signalsの内部実装を理解することで、現代のリアクティブシステムの勘所を掴んでもらうことができます。
 -->
